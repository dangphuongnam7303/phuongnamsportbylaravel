...
<head>
    <title>PN SPORT - Product Detail Page</title>
    <meta charset="utf-8">
    ...
    <div class="container text-light">
        <div class="w-100 d-flex justify-content-between">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:namdpph26892@fpt.edu.vn">namdpph26892@fpt.edu.vn</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                <h2 class="h2 text-success border-bottom pb-3 border-light logo">Phuong Nam SPORT</h2>
                <ul class="list-unstyled text-light footer-link-list">
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="tel:0355262101">0355-262-101</a>
                    </li>
                    <li>
